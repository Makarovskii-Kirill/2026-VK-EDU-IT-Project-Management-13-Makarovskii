...
#### Ручка 1 — Получение списка неназначенных заявок

**`GET /v1/tickets/inbox`**

Возвращает заявки, которые ИИ уже классифицировал и промаршрутизировал, но которые еще не назначены на конкретного сотрудника (очередь на распределение).
...
[
  {
    "id": 1567,
    "subject": "Счет за аренду склада",
    "type": "Счет на оплату",
    "confidence": 0.97,
    "from": "ООО Ромашка",
    "deadline": "2026-05-07T15:00:00Z"
  },
  {
    "id": 1568,
    "subject": "Доп. соглашение к договору",
    "type": "Доп. соглашение",
    "confidence": 0.78,
    "from": "ООО Технология",
...
#### Ручка 2 — Подтверждение заявки

**`POST /v1/tickets/{id}/confirm`**

Сотрудник проверил данные и подтверждает создание документа в 1C.
...
```
{
  "error": "TICKET_ALREADY_PROCESSED",
  "message": "Заявка уже обработана другим сотрудником"
}
```
